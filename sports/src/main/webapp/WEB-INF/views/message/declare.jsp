...
<div class="frame listHead">
	...
	<form method="POST" id="sendMessageMain" action="${cpath }/message/declare">
		<table>
			<tr>
			...
			<tr>
				...
				<td class="tval"><textarea name="content" placeholder="필수: 신고자 ID, 유저명 또는 닉네임 중 하나." required></textarea></td>
			</tr>
		</table>		

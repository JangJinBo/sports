	...
	<div id="pageDiv">
		<ul class="pagination">
			<li class="pagination_button pageMover">
				<a href="?pageNum=1&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">&lt&lt</a>
			</li>
		
			<c:if test="${pageMake.prev }">
			<li class="pagination_button pageMover">
				<a href="?pageNum=${pageMake.startPage - 1 }&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">&lt</a>
			</li>
			</c:if>
			...
			<li class="pagination_button" id="${num }">
				<a href="?pageNum=${num }&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">${num }</a>
			</li>
			</c:forEach>
		
			<c:if test="${pageMake.next }">
			<li class="pagination_button pageMover">
			 	<a href="?pageNum=${pageMake.endPage + 1 }&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">&gt</a>
			</li>
			</c:if>
			<c:if test="${pageMake.next == false }">
			<li class="pagination_button pageMover">
				<a href="?pageNum=${pageMake.realEnd }&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">&gt</a>
			</li>
			</c:if>
			...
			<li class="pagination_button pageMover">
			 	<a href="?pageNum=${pageMake.realEnd }&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }
				&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }">&gt&gt</a>
			</li>
		</ul>
	</div>
	</c:if>
...
<script>	// 온클릭
	function tosv(idx) {
		location.href = cpath + '/space/view/' + idx + '?pageNum=${pageMake.pageNum}&category=${map.category }&region=${map.region }&minPrice=${map.minPrice }&maxPrice=${map.maxPrice }&starRating=${map.starRating }&spaceName=${map.spaceName }'
	}
</script>

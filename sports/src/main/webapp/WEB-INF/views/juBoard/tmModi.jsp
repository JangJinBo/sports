...
<link type="text/css" rel="stylesheet" 
	...
	<div class="frame listHead">
		...
		<form method="POST" enctype="multipart/form-data" id="regForm">
			<input type="hidden" name="writer" value="${tmdto.username }" required>
				<input type="hidden" name="board_idx" value="${tmdto.board_idx }" required>
				<input type="hidden" name="username" value="${tmdto.username }" required>
				<input type="hidden" name="idx" value="${tmdto.idx }" required>
		<table id="regtb">
		<tr>
		<td>제목</td>
			<td>
				<input type="text" name="title"
					placeholder="제목 입력" value="${tmdto.title }" required autofocus>
			</td>
		</tr>
		<tr>
			<td>나이</td>
			<td>
				<input type="text" name="age"
					placeholder="나이 입력" value="${tmdto.age }" required autofocus>
			</td>
		</tr>
		<tr>
			<td>성별</td>
		...
		<tr>
			...
			<td>
				<textarea name="content" placeholder="팀 소개"
					style="resize: none; width: 500px; height: 200px">${tmdto.content }</textarea>
			</td>
		</tr>
		<tr>
			<td>종목</td>
			...
			<input type="text"
				...
				placeholder="종목 입력" value="${tmdto.category }" required autofocus>
			</td>
		</tr>
		<tr>
			<td>지역명</td>
			...
			<input type="text"
				...
				placeholder="간단한 지역명 입력" value="${tmdto.mainarea }" required autofocus>
			</td>
		</tr>
		</table>
	...
	<script>
		...
		tmCancel.onclick = function tmCancelHandler(event) {
			window.history.go(-1)
		}
	</script>
